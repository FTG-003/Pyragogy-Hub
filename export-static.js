...
<head>
  ...
  <!-- Import the built assets (CSS file name will be something like index-[hash].css) -->
  <link rel="stylesheet" href="./assets/index-DWTn3dg9.css">
</head>
<body>
  <div id="root"></div>
  
  <!-- Import the built JS -->
  <script type="module" src="./assets/index-CXyGvEL2.js"></script>
</body>
</html>`;

fs.writeFileSync(path.join(distDir, 'index.html'), indexHtml);

// Copy all files from dist/public directly to static-export
...
// Copy files from dist/public to static-export
copyDirRecursive(distPublicDir, distDir);
